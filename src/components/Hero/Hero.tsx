...
function Hero() {
    return (
        <section className="h-[94dvh] flex items-center justify-center bg-gray-50 hero section-space ">
            <div className="container-css flex flex-col gap-3 items-center ">
                ...
                <p className="font-semibold text-white md:text-[20px] sm:text-[18px] text-[15px] text-center max-w-250">
                    Learn the fundamentals of graphic design, including colors, typography, and layout,
                    and how to create logos, posters, and real-world projects that help you go professional
                    and build a strong portfolio.
                </p>

                <p className="font-semibold text-white md:text-[20px] sm:text-[18px] text-[15px]  text-center max-w-250">
                    This course is designed for all skill levels and provides practical, hands-on skills
                    you can apply directly to your projects, preparing you for a professional career in design.
                </p>
